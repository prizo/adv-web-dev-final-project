    ...
    <div class="col-md-2">
      {!!Form::open(array('data-parsley-validate' => '', 'route' => 'workouts.search', 'method' => 'GET', 'role'=> 'search', 'class'=>''))!!}
        <div class="input-group">
          ...
          <button type="submit" class="btn btn-default">Workouts | {{count($allFoundWorkouts)}}</button>
        </div>
      {!!Form::close()!!}
      <br />
      {!!Form::open(array('data-parsley-validate' => '', 'route' => 'workouts.search', 'method' => 'GET', 'role'=> 'search', 'class'=>''))!!}
        <div class="input-group">
          ...
          <button type="submit" class="btn btn-default">Groups | {{count($allFoundGroups)}}</button>
        </div>
      {!!Form::close()!!}
    </div>
