...
<body id="app-layout">
    ...
    <script src="/AdvWeb_Project/FiitHub/public/assets/js/jquery.backstretch.min.js"></script>
    <script src="/AdvWeb_Project/FiitHub/public/assets/js/scripts.js"></script>
